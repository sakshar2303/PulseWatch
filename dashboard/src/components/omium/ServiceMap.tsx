    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 text-xs font-mono">
            <div className="px-3 py-2 rounded-lg bg-void border border-white/5">
              <span className="text-omium-tertiary block text-[10px]">TOTAL THROUGHPUT</span>
              <span className="text-white font-bold text-sm text-omium-emerald font-mono">2,040 pts/sec</span>
            </div>
            <div className="px-3 py-2 rounded-lg bg-void border border-white/5">
              <span className="text-omium-tertiary block text-[10px]">PIPELINE LOSS</span>
              <span className="text-white font-bold text-sm text-omium-emerald font-mono">0.00%</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 hud-panel rounded-2xl p-6 border border-white/[0.08] bg-void-card relative">
          <div className="text-xs font-mono uppercase tracking-wider text-omium-tertiary mb-6 flex items-center justify-between">
            <span>Telemetry Pipeline Dataflow</span>
            <span className="text-omium-coral flex items-center gap-1">
              <span className="w-1.5 h-1.5 rounded-full bg-omium-coral animate-ping" />
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div
                ...
                className={`p-4 rounded-xl cursor-pointer border transition-all ${
                  selectedNode.id === 'collectors'
                    ? 'border-omium-coral bg-void-elevated shadow-omium-glow'
                    : 'border-white/5 bg-void hover:border-white/20'
                }`}
              >
                <div className="flex items-center justify-between mb-2">
                  <div className="p-2 rounded-lg bg-omium-coral/15 text-omium-coral">
                    <Server className="w-4 h-4" />
                  </div>
                  <span className="text-[10px] font-mono text-omium-emerald bg-omium-emerald/10 px-2 py-0.5 rounded-full">
                    ● Active
                  </span>
                </div>
                <div className="text-xs font-bold text-white font-mono">{NODES[0].name}</div>
                <div className="text-[11px] text-omium-tertiary truncate">{NODES[0].technology}</div>
                <div className="mt-3 pt-2 border-t border-white/5 flex items-center justify-between text-[11px] font-mono">
                  <span className="text-omium-secondary">{NODES[0].throughput}</span>
                  <span className="text-omium-coral">{NODES[0].latency}</span>
                </div>
              </div>

              {/* Arrow Connector */}
              <div className="hidden md:flex items-center justify-center">
                <div className="flex items-center gap-1 text-omium-coral font-mono text-xs">
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <div className="p-2 rounded-lg bg-omium-sky/15 text-omium-sky">
                ...
                <div className="text-[11px] text-omium-tertiary truncate">{NODES[1].technology}</div>
                <div className="mt-3 pt-2 border-t border-white/5 flex items-center justify-between text-[11px] font-mono">
                  <span className="text-omium-secondary">{NODES[1].throughput}</span>
                  <span className="text-omium-sky">{NODES[1].latency}</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-end pr-12">
              <div className="h-6 w-0.5 bg-gradient-to-b from-omium-sky to-omium-emerald" />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <div className="p-2 rounded-lg bg-omium-amber/15 text-omium-amber">
                ...
                <div className="text-[11px] text-omium-tertiary truncate">{NODES[2].technology}</div>
                <div className="mt-3 pt-2 border-t border-white/5 flex items-center justify-between text-[11px] font-mono">
                  <span className="text-omium-secondary">{NODES[2].throughput}</span>
                  <span className="text-omium-amber">{NODES[2].latency}</span>
                </div>
              </div>

              {/* Arrow Connector */}
              <div className="hidden md:flex items-center justify-center">
                <div className="flex items-center gap-1 text-omium-emerald font-mono text-xs">
                  <span className="animate-pulse">━━━</span>
                  <ArrowRight className="w-4 h-4" />
                </div>
              </div>
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <div className="p-2 rounded-lg bg-omium-emerald/15 text-omium-emerald">
                ...
                <div className="text-[11px] text-omium-tertiary truncate">{NODES[3].technology}</div>
                <div className="mt-3 pt-2 border-t border-white/5 flex items-center justify-between text-[11px] font-mono">
                  <span className="text-omium-secondary">{NODES[3].throughput}</span>
                  <span className="text-omium-emerald">{NODES[3].latency}</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <div className="p-2 rounded-lg bg-omium-rose/15 text-omium-rose">
                ...
                <div className="text-[11px] text-omium-tertiary truncate">{NODES[4].technology}</div>
                <div className="mt-3 pt-2 border-t border-white/5 flex items-center justify-between text-[11px] font-mono">
                  <span className="text-omium-secondary">{NODES[4].throughput}</span>
                  <span className="text-omium-rose">{NODES[4].latency}</span>
                </div>
              </div>
              ...
              >
                ...
                <div className="text-[11px] text-omium-tertiary truncate">{NODES[5].technology}</div>
                <div className="mt-3 pt-2 border-t border-white/5 flex items-center justify-between text-[11px] font-mono">
                  <span className="text-omium-secondary">{NODES[5].throughput}</span>
                  <span className="text-omium-sky">{NODES[5].latency}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-4">
          <div className="hud-panel rounded-2xl p-6 border border-white/[0.08] bg-void-card sticky top-20">
            <div className="flex items-center justify-between pb-4 border-b border-white/5">
              <div>
                <span className="text-[10px] font-mono uppercase tracking-wider text-omium-tertiary">
                  Component Inspector
                </span>
              ...
              <span className="text-xs font-mono px-2 py-0.5 rounded bg-omium-emerald/10 text-omium-emerald border border-omium-emerald/20">
                HEALTHY
              </span>
            </div>

            <p className="text-xs text-omium-secondary mt-3 leading-relaxed">
              {selectedNode.details.description}
            </p>

            <div className="mt-5 space-y-2.5">
              <div className="text-[11px] font-mono uppercase text-omium-tertiary tracking-wider">
              ...
              {Object.entries(selectedNode.details.specs).map(([key, val]) => (
                <div key={key} className="p-2.5 rounded-lg bg-void border border-white/5 text-xs font-mono flex items-center justify-between">
                  <span className="text-omium-secondary">{key}</span>
            ...
            <div className="mt-6 pt-4 border-t border-white/5 flex items-center justify-between text-xs font-mono">
              <span className="text-omium-tertiary">Current Rate:</span>
              <span className="text-omium-coral font-bold">{selectedNode.throughput}</span>
            </div>
          </div>
        </div>
      </div>
