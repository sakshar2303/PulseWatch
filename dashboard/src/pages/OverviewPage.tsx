...
export const OverviewPage: React.FC<OverviewPageProps> = ({
  ...
  return (
    <div className="space-y-6 pb-12">
      {/* Omium Hero Headline Banner */}
      <div className="hud-panel rounded-2xl p-6 border border-white/[0.08] relative overflow-hidden bg-void-card">
        <div className="absolute -right-20 -top-20 w-96 h-96 bg-omium-coral/10 rounded-full blur-3xl pointer-events-none" />
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 relative z-10">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-omium-coral/10 border border-omium-coral/25 text-omium-coral text-xs font-mono mb-3 shadow-omium-glow">
              <span className="w-1.5 h-1.5 rounded-full bg-omium-coral animate-ping" />
              Omium Ground-Truth Reliability Engine
            </div>
            ...
            <p className="text-xs lg:text-sm text-omium-secondary mt-2 leading-relaxed">
          ...
          {/* Omium Silent Failure Reduction Stats */}
          <div className="flex items-center gap-4 shrink-0">
            <div className="bg-void p-4 rounded-xl border border-white/[0.08] min-w-[140px]">
              <div className="text-[11px] font-mono text-omium-tertiary uppercase tracking-wider">
                Silent Failures
              </div>
              <div className="text-xl font-bold text-white mt-1 font-mono flex items-center gap-1.5">
                ...
                <span className="text-omium-emerald">→ 0</span>
              </div>
              <div className="text-[10px] text-omium-emerald font-mono mt-1">
            ...
            <div className="bg-void p-4 rounded-xl border border-white/[0.08] min-w-[140px]">
              ...
              <div className="text-xl font-bold text-white mt-1 font-mono text-omium-emerald">
                {sloData?.slis ? `${sloData.slis.success_rate.toFixed(2)}%` : '99.98%'}
              </div>
              <div className="text-[10px] text-omium-secondary font-mono mt-1">
                target: 99.90%
              </div>
            </div>
          </div>
      ...
      <div className="pt-2">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-xs text-omium-secondary mt-0.5">
          ...
          {onNavigateToCheckpoints && (
            <button
              ...
              className="text-xs font-mono text-omium-coral hover:underline"
            >
