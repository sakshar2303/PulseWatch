...
Auditor: PulseWatch Omium Verification Engine
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="hud-panel rounded-2xl p-6 border border-white/[0.08] bg-void-card relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-full bg-gradient-to-l from-omium-emerald/10 to-transparent pointer-events-none" />
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
          <div>
            <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-omium-emerald/10 border border-omium-emerald/20 text-omium-emerald text-xs font-mono mb-2">
              ...
              Omium 4-Step Verification: Connect · Detect · Verify · Prove
            </div>
            <h1 className="text-2xl font-bold text-white tracking-tight">
              Silent Failure Audit & Proof Report
            </h1>
            <p className="text-xs text-omium-secondary mt-1 max-w-2xl leading-relaxed">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handleCopy}
              className="px-3 py-2 rounded-lg bg-void-card hover:bg-void-elevated border border-white/10 text-xs font-mono text-omium-secondary hover:text-white transition-colors flex items-center gap-1.5"
            >
              {copied ? <Check className="w-3.5 h-3.5 text-omium-emerald" /> : <Copy className="w-3.5 h-3.5" />}
              <span>{copied ? 'Copied' : 'Copy Proof'}</span>
            </button>
            <button
              onClick={handleDownload}
              className="px-3.5 py-2 rounded-lg bg-omium-coral hover:bg-omium-coral-hover text-white text-xs font-mono font-semibold transition-all shadow-omium-glow flex items-center gap-1.5"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="hud-panel rounded-xl p-5 border border-white/5 bg-void-card">
          ...
          <div className="text-2xl font-bold text-white mt-1 font-mono flex items-center gap-2">
            <span className="text-omium-coral line-through opacity-70">~2,500</span>
            <span className="text-omium-emerald">→ 0 / day</span>
          </div>
          <div className="flex items-center gap-1 text-[11px] font-mono text-omium-emerald mt-2">
        ...
        <div className="hud-panel rounded-xl p-5 border border-white/5 bg-void-card">
          ...
          <div className="flex items-center gap-1 text-[11px] font-mono text-omium-secondary mt-2">
            <CheckCircle2 className="w-3.5 h-3.5 text-omium-emerald" />
        ...
        <div className="hud-panel rounded-xl p-5 border border-white/5 bg-void-card">
          ...
          <div className="text-2xl font-bold text-omium-coral mt-1 font-mono">
            47 Iterations
          </div>
          <div className="text-[11px] font-mono text-omium-secondary mt-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="hud-panel rounded-2xl p-6 border border-white/[0.08] bg-void-card">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs font-mono text-omium-tertiary">Based on 47 detected events</span>
          </div>
          ...
          <div className="space-y-4">
            <div>
              <div className="flex items-center justify-between text-xs font-mono mb-1">
                ...
                <span className="text-omium-coral font-bold">64%</span>
              </div>
              <div className="w-full bg-white/5 h-2 rounded-full overflow-hidden">
                <div className="bg-omium-coral h-full rounded-full w-[64%]" />
              </div>
              <p className="text-[11px] text-omium-secondary mt-1">
            ...
            <div>
              <div className="flex items-center justify-between text-xs font-mono mb-1">
                ...
                <span className="text-omium-amber font-bold">24%</span>
              </div>
              <div className="w-full bg-white/5 h-2 rounded-full overflow-hidden">
                <div className="bg-omium-amber h-full rounded-full w-[24%]" />
              </div>
              <p className="text-[11px] text-omium-secondary mt-1">
            ...
            <div>
              <div className="flex items-center justify-between text-xs font-mono mb-1">
                ...
                <span className="text-omium-sky font-bold">12%</span>
              </div>
              <div className="w-full bg-white/5 h-2 rounded-full overflow-hidden">
                <div className="bg-omium-sky h-full rounded-full w-[12%]" />
              </div>
              <p className="text-[11px] text-omium-secondary mt-1">
        ...
        <div className="hud-panel rounded-2xl p-6 border border-white/[0.08] bg-void-card">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-bold text-white font-mono uppercase tracking-wider">
              Omium 4-Step Verification Cycle
            </h3>
            <span className="text-xs font-mono text-omium-emerald">Autonomous</span>
          </div>

          <div className="space-y-3 font-mono text-xs">
            <div className="p-3 rounded-xl bg-void border border-white/5 flex items-start gap-3">
              <span className="font-bold text-omium-coral">01</span>
              <div>
                <div className="text-white font-semibold">Connect SDK</div>
                <div className="text-[11px] text-omium-secondary">
            ...
            <div className="p-3 rounded-xl bg-void border border-white/5 flex items-start gap-3">
              <span className="font-bold text-omium-sky">02</span>
              <div>
            ...
            <div className="p-3 rounded-xl bg-void border border-white/5 flex items-start gap-3">
              <span className="font-bold text-omium-emerald">03</span>
              <div>
            ...
            <div className="p-3 rounded-xl bg-void border border-white/5 flex items-start gap-3">
              <span className="font-bold text-omium-amber">04</span>
              <div>
      ...
      <div className="hud-panel rounded-2xl p-6 border border-white/[0.08] bg-void-card">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            <FileText className="w-4 h-4 text-omium-coral" />
            <h3 className="text-sm font-bold text-white font-mono uppercase tracking-wider">
              Executive Audit Proof Preview
            </h3>
          </div>
          <span className="text-[11px] font-mono text-omium-tertiary">Markdown Output</span>
        </div>

        <pre className="p-4 rounded-xl bg-void border border-white/5 text-xs font-mono text-omium-secondary overflow-x-auto whitespace-pre leading-relaxed">
          {auditReportMarkdown}
        </pre>
      </div>
    </div>
